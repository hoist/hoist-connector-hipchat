window.esdocSearchIndex = [
  ...
  [
    "",
    "test-file/tests/integration_tests/auth_tests.js.html#lineNumber86",
    "authorization steps on first bounce should redirect user to install addon",
    "test"
  ],
  [
    "",
    "test-file/tests/integration_tests/rooms_api_tests.js.html#lineNumber7",
    "messages api",
    "test"
  ],
  [
    "",
    "test-file/tests/integration_tests/rooms_api_tests.js.html#lineNumber16",
    "messages api get all messages",
    "test"
  ],
  [
    "",
    "test-file/tests/integration_tests/rooms_api_tests.js.html#lineNumber43",
    "messages api get all messages returns list of rooms",
    "test"
  ],
  [
    "",
    "test-file/tests/integration_tests/rooms_api_tests.js.html#lineNumber47",
    "messages api send a notification",
    "test"
  ],
  [
    "",
    "test-file/tests/integration_tests/rooms_api_tests.js.html#lineNumber74",
    "messages api send a notification returns list of rooms",
    "test"
  ],
  [
    "src/connector.js",
  ...
  [
    "src/connector.js~hipchat#authorize",
    "class/src/connector.js~HipChat.html#instance-method-authorize",
    "src/connector.js~HipChat#authorize",
    "method"
  ],
  [
    "src/connector.js~hipchat#configure",
    "class/src/connector.js~HipChat.html#instance-method-configure",
    "src/connector.js~HipChat#configure",
    "method"
  ],
  [
    "src/connector.js~hipchat#constructor",
    "class/src/connector.js~HipChat.html#instance-constructor-constructor",
    "src/connector.js~HipChat#constructor",
    "method"
  ],
  [
    "src/connector.js~hipchat#delete",
    "class/src/connector.js~HipChat.html#instance-method-delete",
    "src/connector.js~HipChat#delete",
    "method"
  ],
  [
    "src/connector.js~hipchat#get",
    "class/src/connector.js~HipChat.html#instance-method-get",
    "src/connector.js~HipChat#get",
    "method"
  ],
  [
    "src/connector.js~hipchat#intercept",
    "class/src/connector.js~HipChat.html#instance-method-intercept",
    "src/connector.js~HipChat#intercept",
    "method"
  ],
  [
    "src/connector.js~hipchat#patch",
    "class/src/connector.js~HipChat.html#instance-method-patch",
    "src/connector.js~HipChat#patch",
    "method"
  ],
  [
    "src/connector.js~hipchat#post",
    "class/src/connector.js~HipChat.html#instance-method-post",
    "src/connector.js~HipChat#post",
    "method"
  ],
  [
  ...
  [
    "tests/integration_tests/rooms_api_tests.js",
    "test-file/tests/integration_tests/rooms_api_tests.js.html",
    "tests/integration_tests/rooms_api_tests.js",
    "testFile"
  ]
]